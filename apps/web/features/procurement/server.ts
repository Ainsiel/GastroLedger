...
import { loadProcurementCatalog, type ProcurementCatalogSnapshot } from "./suppliers";
...
export async function loadProcurementCatalogFromServer(): Promise<ProcurementCatalogSnapshot> {
  ...
  return loadProcurementCatalog(serverFetch);
}
